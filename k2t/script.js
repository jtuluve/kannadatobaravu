...
/* Baravu requires ೆ to be in the starting of the letter i.e. ಕೆ = ek where ಕ = k and ೆ = e also ಕ್ಕೆ = ekAk (where ್ = A). We need to find ೆ and change its position to the starting of letter */
let e = txt.indexOf("ೆ");
let n =  txt.indexOf("ೆ");
let m = 1;
while(e>-1){
...
// replace ೇ with E (position is strating of the letter as in ೆ)
e = txt.indexOf("ೇ");
n =  txt.indexOf("ೇ");
 m = 1;
while(e>-1){
...
//to solve font error in website 
txt = txt.replace(/് /g, "്  ");
